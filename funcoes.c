...
void PesquisaEstadia(estadia vetor_estadia[], Cliente vetor_cliente[]);
...
// Inicio Funcoes Pesquisa estadias
void PesquisaEstadia(estadia vetor_Estadias[], Cliente vetor_clientes[]){
    ...
    while (!feof(arqCLientes)){
        fgets(RecebeCliente, ClientSize, arqCLientes);
        substr = strtok(RecebeCliente, ";");
            ...
            printf("%.0f", vetor_clientes[i].telefone);
            substr = strtok(NULL, ";");
    ...
    FILE *leTxt = fopen("estadias.txt", "r");
    char RecebeEstadia[sizeof(estadia)];
    char *divideStr;
    int index = 0;
    
    while (!feof(leTxt)){
        fgets(RecebeEstadia, sizeof(estadia), leTxt);
        divideStr = strtok(RecebeEstadia, ";");
        while (divideStr){
        vetor_Estadias[index].id = atoi(divideStr);
        divideStr = strtok(NULL, ";");
        vetor_Estadias[index].dataEntrada.dia = atoi(divideStr);
        divideStr = strtok(NULL, ";");
        vetor_Estadias[index].dataEntrada.mes = atoi(divideStr);
        divideStr = strtok(NULL, ";");
        vetor_Estadias[index].dataEntrada.ano = atoi(divideStr);
        divideStr = strtok(NULL, ";");
        vetor_Estadias[index].dataSaida.dia = atoi(divideStr);
        divideStr = strtok(NULL, ";");
        vetor_Estadias[index].dataSaida.mes = atoi(divideStr);
        divideStr = strtok(NULL, ";");
        vetor_Estadias[index].dataSaida.ano = atoi(divideStr);
        divideStr = strtok(NULL, ";");
        vetor_Estadias[index].totalDiarias = atoi(divideStr);
        divideStr = strtok(NULL, ";");
        vetor_Estadias[index].idCliente = atoi(divideStr);
        divideStr = strtok(NULL, ";");
        vetor_Estadias[index].numeroQuarto= atoi(divideStr);
        divideStr = strtok(NULL, ";");
        index++;
        }
    }
    ...
    for (i = 0; i < index; i++){
        if (idProcurado == vetor_Estadias[i].idCliente){
            printf("\nID Estadia:  %d\tData de entrada: %d/%d/%d\tData de saida:  %d/%d/%d\tQuantidade de dias:  %d\tID Cliente: %d\tNumero do quarto:  %d\n", vetor_Estadias[i].id,vetor_Estadias[i].dataEntrada.dia,vetor_Estadias[i].dataEntrada.mes,vetor_Estadias[i].dataEntrada.ano,vetor_Estadias[i].dataSaida.dia, vetor_Estadias[i].dataSaida.mes, vetor_Estadias[i].dataSaida.ano, vetor_Estadias[i].totalDiarias, vetor_Estadias[i].idCliente, vetor_Estadias[i].numeroQuarto);
            estadiasImpressas++;
        }
    }
